...
* [ctuning / reproduce-milepost-project](https://github.com/ctuning/reproduce-milepost-project):Customizable Collective Knowledge experimental workflow for MILEPOST GCC (machine learning based compiler) to let the community reproduce and build upon our past R&D projects. However, it is current outdated and we continue this research in this CK repository:
* [grpc / grpc](https://github.com/grpc/grpc):The C based gRPC (C++, Node.js, Python, Ruby, Objective-C, PHP, C#)
* [ctuning / ck-clsmith](https://github.com/ctuning/ck-clsmith):Collective Knowledge extension to crowdsource bug detection in OpenCL compilers using CLSmith tool from ICL
